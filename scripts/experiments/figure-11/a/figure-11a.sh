...
# Figure 11a: Performance impact of window slide
...
#
F="$SABER_HOME/scripts/experiments/figure-11/a"
major=
minor=
...
saberExperimentRun () {
	#
	# for N in 1 2 4 8 16 32 64 128 256 512 1024 tuples/slide (i.e. from 32B to 32KB)
	# do 
	# 	Run Selection CPU-only with $N tuples/slide (N-1)
	# 	Run Selection GPU-only with $N tuples/slide (N-2)
	# 	Run Selection Hybrid   with $N tuples/slide (N-3)
	# done
	#
	errors=0
	points=0
...
saberExperimentCheckResults () {
	...
	DATDIR="$ORIGIN/figure-11/selection"
	#
	# Data format:
	#
	#     x    MIN         AVG              ...
	# _________________________________________
	#    64    2464.570    2658.27668852    ...
	#   256    2468.156    2656.86026230    ...
	#   ...
	# 32768    2590.410    2745.75929508    ...
	#
