...
# Figure 8: Performance of synthetic queries. `AGG*` evaluates all aggregate functions and GPOUP-BY evaluates `count` and `sum`.
...
#
F="$SABER_HOME/scripts/experiments/figure-08"
major=
minor=
