...
public class TestSelection {
	...
	public static void main (String [] args) {
		...
		try {
            ...
            SystemConf.INPUT_SCHEMA_SIZE = 16;
            batchSize = 1048576/SystemConf.INPUT_SCHEMA_SIZE;
