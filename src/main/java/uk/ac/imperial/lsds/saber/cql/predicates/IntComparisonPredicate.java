...
public class IntComparisonPredicate implements IPredicate {
	...
	public IntComparisonPredicate (int op, IntExpression v1, IntExpression v2) {
		this.op = op;
		this.v1 = v1;
		this.v2 = v2;
	}
	...
	public boolean satisfied (
		...
		int val1 = v1.eval(buffer1, schema1, offset1);
		int val2 = v2.eval(buffer2, schema2, offset2);
