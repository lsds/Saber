...
public class ThetaJoinKernel implements IOperatorCode {
	...
	public ThetaJoinKernel (ITupleSchema left, ITupleSchema right, IPredicate predicate, String customPredicate, 
