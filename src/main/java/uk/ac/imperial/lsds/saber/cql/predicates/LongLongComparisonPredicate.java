...
public class LongLongComparisonPredicate implements IPredicate {
	...
	LongLongExpression v1;
	LongLongExpression v2;
	
	public LongLongComparisonPredicate (LongLongExpression v1, LongLongExpression v2) {
		this(EQUAL_OP, v1, v2);
	}
	
	public LongLongComparisonPredicate (int op, LongLongExpression v1, LongLongExpression v2) {
		this.op = op;
		this.v1 = v1;
		this.v2 = v2;		
	}
	...
	private boolean compare (long msbVal1, long lsbVal1, long msbVal2, long lsbVal2) {
		switch (op) {
		case      EQUAL_OP: return (msbVal1 == msbVal2 && lsbVal1 == lsbVal2);
		case   NONEQUAL_OP: return (msbVal1 != msbVal2 || lsbVal1 != lsbVal2);
		case       LESS_OP: return (msbVal1 < msbVal2 || (msbVal1 == msbVal2 && lsbVal1 < lsbVal2)); 
		case    NONLESS_OP: return (msbVal1 > msbVal2 || (msbVal1 == msbVal2 && lsbVal1 >= lsbVal2));
		case    GREATER_OP: return (msbVal1 > msbVal2 || (msbVal1 == msbVal2 && lsbVal1 > lsbVal2));
		case NONGREATER_OP: return (msbVal1 <= msbVal2 || (msbVal1 == msbVal2 && lsbVal1 <= lsbVal2));
		default:
	...
	public boolean satisfied (IQueryBuffer buffer, ITupleSchema schema, int offset) {
		...
		long msbVal1 = v1.evalMSB(buffer, schema, offset);
		long lsbVal1 = v1.evalLSB(buffer, schema, offset);
		long msbVal2 = v2.evalMSB(buffer, schema, offset);
		long lsbVal2 = v2.evalLSB(buffer, schema, offset);

		return compare (msbVal1, lsbVal1, msbVal2, lsbVal2);
	}
	...
	public boolean satisfied (
		...
		long msbVal1 = v1.evalMSB(buffer1, schema1, offset1);
		long lsbVal1 = v1.evalLSB(buffer1, schema1, offset1);
		long msbVal2 = v2.evalMSB(buffer2, schema2, offset2);
		long lsbVal2 = v2.evalLSB(buffer2, schema2, offset2);
