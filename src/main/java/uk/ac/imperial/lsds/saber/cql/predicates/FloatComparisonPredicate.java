...
public class FloatComparisonPredicate implements IPredicate {
	...
	public FloatComparisonPredicate (int op, FloatExpression v1, FloatExpression v2) {
		this.op = op;
		this.v1 = v1;
		this.v2 = v2;
	}
	...
	private boolean compare (float val1, float val2) {
		switch (op) {
	...
	public boolean satisfied (
		...
		float val1 = v1.eval(buffer1, schema1, offset1);
		float val2 = v2.eval(buffer2, schema2, offset2);
